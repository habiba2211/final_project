...
class _SettingScreenState extends State<SettingScreen> {
  ...
  TextStyle txtStyle = TextStyle(fontWeight: FontWeight.bold, fontSize: 20);
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Edit Photo",
                                        style: txtStyle.copyWith(fontSize: 25),
                                      )
                                    ],
                                  ),
                                ),
                ...
                Text("Edit Account", style: txtStyle.copyWith(fontSize: 30)),
                SizedBox(
                  height: 20,
                ),
                InkWell(
  ...
  void displayBottomSheet() {
    showModalBottomSheet(
        context: context, builder: (context) => DispalyBottomSheet());
  }
